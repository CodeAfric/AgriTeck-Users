...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: selectedPage==BottomButtons.Home?primaryLight.withOpacity(0.5):primaryDark,
        title: Text(
          selectedPage==BottomButtons.Market?'Market':
          selectedPage==BottomButtons.Farms?'Farms':
          selectedPage==BottomButtons.Crops?'Crops':
          selectedPage==BottomButtons.Community?'Community':'',
      ...
      bottomNavigationBar: Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Row(
            ...
            children: [
              BottomIcons(iconColor: primary,
                text: 'Home',bottomIcons: selectedPage==BottomButtons.Home?true:false,
                icons:'assets/icons/home.png',
                textColor: Colors.white, onPressed: (){
                  setState(() {
                    selectedPage=BottomButtons.Home;
                  });
                }, activeColor: primary, activeIconColor: Colors.white ,),
              BottomIcons(iconColor: primary,
                text: 'Crops',bottomIcons: selectedPage==BottomButtons.Crops?true:false,
              ...
              BottomIcons(iconColor: primary,
                text: 'Farms',bottomIcons: selectedPage==BottomButtons.Farms?true:false,
              ...
              BottomIcons(iconColor: primary,
                text: 'Community',bottomIcons: selectedPage==BottomButtons.Community?true:false,
              ...
              BottomIcons(iconColor: primary,
                text: 'Market',bottomIcons: selectedPage==BottomButtons.Market?true:false,
