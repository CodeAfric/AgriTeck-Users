  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Post Details', style: TextStyle(fontWeight: FontWeight.w600, fontSize:18, color: Colors.white),),
      ),
      body: SafeArea(
                ...
                Expanded(
                  ...
                  child: Container(
                    child: ListTile(
                      ...
                      title:  Text(comm.comenterLocation, style: TextStyle(fontSize: 15,color:primary, fontWeight:FontWeight.w400 ),
                        maxLines: 1,),
                    ),
                  ),
                ),
