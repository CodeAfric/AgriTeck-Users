...
//   }
//
//   _sendCodeToPhone(String phoneNumber) async {
//     setState(() {
//       isLoading = true;
//     });
...
//             sendToPage(context, OTPScreen(verficationID, _phone));
//           });
//         },
...
//             isLoading = false;
//             await showSnackBar('OTP sent to Phone', _scaffoldKey.currentState);
//             sendToPage(context, OTPScreen(verificationID, _phone));
//           });
//         },
